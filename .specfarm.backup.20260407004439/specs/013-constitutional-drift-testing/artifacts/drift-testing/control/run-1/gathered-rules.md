...
[0;32m===[0m [0;34mValidating Environment[0m [0;32m===[0m
  ...
  [1;33m[WARN][0m Schema file not found: /tmp/drift-control-run-1-8997/rules-schema.xsd
  [1;33m[INFO][0m Continuing without schema validation
  [0;32m[✓][0m Output directory writable: /tmp/drift-control-run-1-8997
  [1;33m[INFO][0m Auto-enabled --scan-tests (rules: 19 < param(1) × tests: 175)
  [1;33m[INFO][0m Invalidating commit cache: rules.xml mtime changed (1775364222 -> 1775450326)
...
[0;32m===[0m [0;34mScanning Repository[0m [0;32m===[0m
  [1;33m[INFO][0m Repository: /tmp/drift-control-run-1-8997
...
[0;32m===[0m [0;34mGenerating Report[0m [0;32m===[0m
  [0;32m[✓][0m Report generated: /tmp/drift-control-run-1-8997/gathered-rules.md

[0;32m===[0m [0;34m✓ Execution Complete[0m [0;32m===[0m
  [0;32m[✓][0m Report available: /tmp/drift-control-run-1-8997/gathered-rules.md
